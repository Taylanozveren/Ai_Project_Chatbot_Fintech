...
# ── TensorFlow (tf-keras 2.15) ───────────────────────────────────────────
import sys                      # önce sys
import tensorflow as tf         # tf.keras kullanacağız; EKSTRA ayar gerekmiyor
#  ⛔ TF_USE_LEGACY_KERAS satırını KALDIRDIK
#  ⛔ Herhangi bir “alias” (sys.modules["keras"] …) TANIMLAMIYORUZ
# ─────────────────────────────────────────────────────────────────────────
